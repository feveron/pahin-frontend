...
export function FormCard({
  ...
  return (
    <div
      className={`
        w-full min-h-[680px] max-w-[420px] aspect-[3/4] overflow-hidden  bg-white dark:bg-neutral-900 rounded-3xl flex flex-col
        ${className}
      `}
    >
      {/* IMAGE */}
      <div className="relative w-full h-[33%]">
        ...
        {hide && (
          <img
            ...
            alt="Placeholder"
            className="absolute inset-0 w-full rounded-3xl min-[440px]:rounded-none h-full object-cover"
          />
        )}
        {/* TAG */}
