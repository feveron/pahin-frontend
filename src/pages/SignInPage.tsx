                ...
                <div className="flex md:h-[680px] dark:bg-neutral-700 max-w-[1200px] flex-col md:flex-row items-center justify-center bg-white rounded-bl-none md:rounded-bl-3xl rounded-3xl shadow-[0_24px_48px_rgba(69,60,30,0.12),0_18px_40px_rgba(69,60,30,0.08)]">
                    <div className="flex-1 md:w-[50%] h-full flex items-start justify-start">
                        <img
                            src={Baner}
                            alt="banner"
                            className="h-full object-contain object-left-top rounded-tl-3xl"
                        />
                    </div>

                    <div className="md:w-[50%] flex flex-col rounded-r-3xl items-start h-full bg-white dark:bg-neutral-700 gap-10 p-6 md:p-[46px] lg:p-[96px]">
                        <div className="flex flex-col items-start gap-2">
                            ...
                            <p className="text-start text-[14px] dark:text-white/70 text-footer text-dark-footer justify-between">
                                Будь ласка, введіть свої дані, щоб увійти у свій акаунт.
                            </p>
                        </div>
